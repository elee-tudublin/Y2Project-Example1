...
# pub
# mosquitto_pub -h broker.hivemq.com -t elee-event-log/type/level/timestamp/source/computer/user/description -m application,error,,database,dbserver,admin,crash